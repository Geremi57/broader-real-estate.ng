      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div *ngFor="let property of featuredProperties; let i = index" 
            ...
            <!-- Main Card -->
            <div (click)="viewPropertyDetails(property)" class="relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-emerald-100/50 hover:border-emerald-200 h-full transform hover:-translate-y-2" 
            >
